    ...
    class GuiaRepositorio
    {
        public static long Agregar(guia pGuia)
        {
            ...
            MySqlCommand comando = new MySqlCommand(string.Format("INSERT INTO tte_guia (codigo_operacion_ingreso_fk, " +
				...
				"vr_cobro_entrega, cortesia, mercancia_peligrosa, tipo_liquidacion)" +
				...
				pGuia.vrCobroEntrega, pGuia.cortesia, pGuia.mercanciaPeligrosa, pGuia.tipoLiquidacion), BdCromo.ObtenerConexion());
