...
namespace cromo
{
    ...
    public partial class FrmGuia : Form
    {
		...
		private void TsbVistaPrevia_Click(object sender, EventArgs e)
		{
            ...
            /*string pdfPath = Path.Combine(Application.StartupPath, @"C:\prueba\prueba.pdf");
            Process.Start(pdfPath);*/

            /*ProcessStartInfo info = new ProcessStartInfo();
            info.Verb = "print";
            info.FileName = @"C:\prueba\prueba.pdf";
            ...
            PdfWriter writer = PdfWriter.GetInstance(doc,
                            new FileStream(@"C:\prueba\prueba.pdf", FileMode.Create));
